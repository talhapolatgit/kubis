...
return new class extends Migration
{
    ...
    {
        $exists = DB::table('entegrasyonlar')->where('tip', 'kimlik')->exists();
        if ($exists) {
            return;
        }

        $ayarlar = [
            'base_url' => 'https://10.40.8.16/FlexCityUi/rest/json/sbs/FindSbsKisiDtoByNvi',
    ...
    {
        DB::table('entegrasyonlar')->where('tip', 'kimlik')->delete();
    }
};
