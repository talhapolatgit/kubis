...
@section('title', 'Beyoglu Kutuphane Sistemi')
                            ...
                            <div>
                                    ...
                                    <div class="form-field" style="grid-column: span 2;">
                                        ...
                                        <div class="yazar-giris-tip-row" style="display:flex;flex-wrap:wrap;gap:18px;margin-top:6px;margin-bottom:10px;">
                                            <label style="display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-size:14px;">
                                                <input type="radio" name="yazar_giris_tipi" id="yazarGirisKayitli" value="kayitli" checked />
                                                <span>Kayıtlı Yazarlardan Seç</span>
                                            </label>
                                            <label style="display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-size:14px;">
                                                <input type="radio" name="yazar_giris_tipi" id="yazarGirisManuel" value="manuel" />
                                        ...
                                        <fieldset id="yazarKayitliFieldset" style="border:none;padding:0;margin:0;min-width:0;">
                                            <div id="yazarKayitliPickArea" style="{{ old('yazar_giris_tipi') === 'manuel' ? 'display:none;' : '' }}">
                                                ...
                                                <input type="hidden" name="kunyeYazar" id="kunyeYazar" value="{{ old('kunyeYazar') }}" />
                                        ...
                                        <fieldset id="yazarManuelFieldset" disabled style="border:none;padding:0;margin:0;margin-top:12px;min-width:0;{{ old('yazar_giris_tipi') === 'manuel' ? '' : 'display:none;' }}">
                                            <p class="form-hint" style="margin:0 0 8px;font-size:12px;color:var(--muted-foreground);">Ad ve soyadı girin, «Ekle» ile listeye ekleyin. Kayıtta yazar tablosuna yazılır.</p>
                                ...
                                <div class="form-grid cols-2" style="margin-top:16px;">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="hidden" id="altTurId" value="{{ old('altTurId') }}" />
                                        <input type="hidden" id="altTurAd" name="altTurAd" value="{{ old('altTurAd', optional($altturler->firstWhere('id', old('altTurId')))->ad ?? '') }}" />
                            ...
                            <div>
                                ...
                                <div class="form-grid cols-3">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <select class="form-select" id="koleksiyon_id" name="koleksiyon_id">
                                            <option value="">— Seçiniz —</option>
                                            @foreach($koleksiyonlar as $kol)
                                                <option value="{{ $kol->id }}" {{ (string) old('koleksiyon_id', '') === (string) $kol->id ? 'selected' : '' }}>{{ $kol->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-field" style="position:relative;">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="number" class="form-input" id="kunyeSayfaSayisi" name="kunyeSayfaSayisi" placeholder="Örnek: 350" min="1" value="{{ old('kunyeSayfaSayisi') }}" />
                                    </div>
                                    <div class="form-field">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="checkbox-group" style="margin-top:2px;">
                                            <label class="checkbox-item">
                                                <input type="checkbox" id="oduncVerilemez" name="oduncVerilemez" value="1" {{ old('oduncVerilemez') ? 'checked' : '' }}>
                                            ...
                                            <label class="checkbox-item">
                                                <input type="checkbox" id="etiketlendi" name="etiketlendi" value="1" {{ old('etiketlendi') ? 'checked' : '' }}>
                                                <span class="checkbox-box">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                                                </span>
                                                <span class="checkbox-label">
...
<script>
    ...
    (function () {
        ...
        if (initialCopyPrefill) {
            setTimeout(function () { applyDatabasePrefill(initialCopyPrefill); }, 0);
        }
        if (initialCopyCover) {
                ...
                .then(function (data) {
                    if (data.success) {
                        ...
                        if (data.cover) {
                            ...
                            coverInput.value = '';
                            var copyKapakHidden = document.getElementById('copyKapakFromId');
                            var hiddenIsbn = document.getElementById('isbnCoverUrl');
    ...
    bookForm.addEventListener('submit', function(e) {
        ...
        if (window.syncKunyeYazarHiddenForSubmit) window.syncKunyeYazarHiddenForSubmit();
        // altTurAd hidden alanını doldur (controller find-or-create için)
    ...
    function resetForm() {
        ...
        var koleksiyonSel = document.getElementById('koleksiyon_id');
        if (koleksiyonSel) koleksiyonSel.value = '';
        ...
        var altTurAdEl = document.getElementById('altTurAd');
        if (altTurAdEl) altTurAdEl.value = '';
    ...
    (function() {
        function initDbCombobox(cfg) {
            // cfg: { wrapperId, searchInputId, hiddenInputId, dataScriptId, labelKey, strict, idKey }
