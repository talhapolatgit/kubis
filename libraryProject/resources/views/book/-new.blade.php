            ...
            <form id="bookForm" class="form-card" method="POST" action="{{ route('katalog.store') }}" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-card-header">
                    ...
                    <p class="form-card-desc">
                        Kütüphaneye eklenecek eserin bilgilerini aşağıdaki formu doldurarak giriniz.
                    </p>
                </div>
                        ...
                        <div class="fields-section">
                            ...
                            <div>
                                ...
                                <div class="form-grid cols-2">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="authorCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="kunyeYazarSearch" placeholder="Yazar adı yazın veya seçin" autocomplete="off" required />
                                        ...
                                        <input type="hidden" id="kunyeYazar" name="kunyeYazar" value="{{ old('kunyeYazar') }}" />
                                        {{-- JS için DB verisi --}}
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="input-with-icon" style="position:relative;">
                                            <input type="text" class="form-input" id="kunyeISBNISSN" name="kunyeISBNISSN" placeholder="978-3-16-148410-0" required style="padding-right:40px;" />
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="number" class="form-input" id="kunyeKopya" name="kunyeKopya" value="1" min="1" />
                                    </div>
                                </div>
                                ...
                                <div class="form-grid cols-2" style="margin-top:16px;">
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="turCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="turIdSearch" placeholder="Tür ara veya seçin…" autocomplete="off" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="altTurCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="altTurIdSearch" placeholder="Alt tür ara veya seçin…" autocomplete="off" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                        ...
                                        <input type="hidden" id="altTurId" name="altTurId" value="{{ old('altTurId') }}" />
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="sekilCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="sekilIdSearch" placeholder="Şekil ara veya seçin…" autocomplete="off" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="ortamCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="ortamIdSearch" placeholder="Ortam ara veya seçin…" autocomplete="off" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                ...
                                <div style="margin-top:16px;">
                                    ...
                                    <input type="hidden" id="ustEserKatalogId" name="ustEserKatalogId" value="{{ old('ustEserKatalogId') }}" />
                                </div>
                            </div>
                                ...
                                <div class="form-grid cols-3">
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="publisherCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="kunyeYayinlayanSearch" placeholder="Yayınevi yazın veya seçin" autocomplete="off" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                        ...
                                        <input type="hidden" id="kunyeYayinlayan" name="kunyeYayinlayan" value="{{ old('kunyeYayinlayan') }}" />
                            ...
                            <div>
                                ...
                                <div class="form-grid cols-3">
                                    <div class="form-field">
                                        ...
                                        <input type="hidden" id="kunyeKategori" name="kunyeKategori" value="{{ old('kunyeKategori') }}" />
                                ...
                                <div style="margin-top:24px;">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <select class="form-select" id="girisTuruId" name="girisTuruId">
                                                ...
                                                @foreach($girisTurleri as $gt)
                                                    <option value="{{ $gt->id }}" data-ad="{{ $gt->ad }}" {{ old('girisTuruId') == $gt->id ? 'selected' : '' }}>
                                                        {{ $gt->ad }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div id="satin-alma-fields" class="form-grid cols-3" style="display:none;margin-top:16px;">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="date" class="form-input" id="faturaTarihi" name="faturaTarihi" value="{{ old('faturaTarihi') }}" />
                                        </div>
                                        <div class="form-field">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="email" class="form-input" id="tedarikciEposta" name="tedarikciEposta" placeholder="ornek@firma.com" value="{{ old('tedarikciEposta') }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="fiyat">Fiyat (₺)</label>
                                            <input type="number" class="form-input" id="fiyat" name="fiyat" placeholder="0.00" step="0.01" min="0" value="{{ old('fiyat') }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div id="hibe-fields" class="form-grid cols-3" style="display:none;margin-top:16px;">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="email" class="form-input" id="tedarikciEposta_hibe" placeholder="ornek@kurum.com" value="{{ old('tedarikciEposta') }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div id="bagis-fields" class="form-grid cols-3" style="display:none;margin-top:16px;">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="email" class="form-input" id="tedarikciEposta_bagis" placeholder="ornek@eposta.com" value="{{ old('tedarikciEposta') }}" />
                                        </div>
                                    </div>

                                    {{-- Gizli gerçek input'lar - JS ile doldurulur --}}
                                    <input type="hidden" id="tedarikci_hidden" name="tedarikci" value="{{ old('tedarikci') }}" />
                                    <input type="hidden" id="tedarikciTelefon_hidden" name="tedarikciTelefon" value="{{ old('tedarikciTelefon') }}" />
                                    <input type="hidden" id="tedarikciEposta_hidden" name="tedarikciEposta" value="{{ old('tedarikciEposta') }}" />
                                </div>
                            </div>
                                        ...
                                        <select class="form-select" id="kutuphaneId" name="kutuphaneId">
                                            ...
                                            @foreach($kutuphaneler as $kutuphane)
                                                <option value="{{ $kutuphane->id }}"
                                                    {{ old('kutuphaneId') == $kutuphane->id ? 'selected' : '' }}>
                                                    {{ $kutuphane->title }}
                                                </option>
                                            @endforeach
                                        </select>
