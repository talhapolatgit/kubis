                            ...
                            <div class="label-type-grid">
                                <label class="label-type-card">
                                    ...
                                    <div class="label-type-inner">
                                        ...
                                        <div class="label-type-text">
                                            <div class="label-type-name">Tip 1</div>
                                ...
                                <label class="label-type-card">
                                    ...
                                    <div class="label-type-inner">
                                        ...
                                        <div class="label-type-text">
                                            <div class="label-type-name">Tip 2</div>
                                ...
                                <label class="label-type-card">
                                    ...
                                    <div class="label-type-inner">
                                        ...
                                        <div class="label-type-text">
                                            <div class="label-type-name">Tip 3</div>
                                ...
                                <label class="label-type-card">
                                    ...
                                    <div class="label-type-inner">
                                        ...
                                        <div class="label-type-text">
                                            <div class="label-type-name">Tip 4</div>
                                            <div class="label-type-desc">A4 · Kitap başına Tip 2 + Tip 3 yan yana · Her kitap 2 etiket</div>
                                        </div>
                                        <div class="label-type-radio"></div>
                                    </div>
                                </label>
    ...
    function generatePDF() {
        ...
        setTimeout(function() {
            try {
                ...
                var pageCalcCount = (tip === 'tip4') ? selectedBooks.length * 2 : selectedBooks.length;
                showToast('success', 'PDF oluşturuldu',
                    selectedBooks.length + ' kitap · ' +
                    Math.ceil((pageCalcCount + skip) / perPage) + ' sayfa' + skipNote);
            } catch(e) {
