...
<head>
    ...
    <title>Kitap Kopyala — Beyoğlu Kütüphane Sistemi</title>
    ...
    <main class="main-content" id="mainContent">
        ...
        <header class="top-header">
            ...
            <nav class="breadcrumb" aria-label="Breadcrumb">
                ...
                <span class="breadcrumb-current">Yeni Kayıt</span>
            </nav>
            ...
            <form id="bookForm" class="form-card" method="POST" action="{{ route('katalog.store') }}" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-card-header">
                    ...
                    <p class="form-card-desc">
                        <strong>{{ $kitap->kunyeEserAdi }}</strong> kaydından kopyalandı. Gerekli alanları düzenleyip kaydedin.
                    </p>
                </div>
                            ...
                            <div>
                                ...
                                <div class="form-grid cols-2">
                                    <div class="form-field">
                                        ...
                                        <input type="text" class="form-input" id="kunyeEserAdi" name="kunyeEserAdi" placeholder="Örnek: Sefiller" required value="{{ $kitap->kunyeEserAdi }}" />
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeEserAdiAlt">Alt Başlık</label>
                                        <input type="text" class="form-input" id="kunyeEserAdiAlt" name="kunyeEserAdiAlt" placeholder="Örnek: Birinci kısım" required value="{{ $kitap->kunyeEserAdiAlt }}" />
                                    </div>
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="authorCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="kunyeYazarSearch" placeholder="Yazar adı yazın veya seçin" autocomplete="off" required value="{{ $kitap->kunyeYazar }}" />
                                        ...
                                        {{-- Metin değeri (form gönderiminde kullanılır, controller find-or-create yapar) --}}
                                        <input type="hidden" id="kunyeYazar" name="kunyeYazar" value="{{ $kitap->kunyeYazar }}" />
                                        {{-- JS için DB verisi --}}
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="input-with-icon" style="position:relative;">
                                            <input type="text" class="form-input" id="kunyeISBNISSN" name="kunyeISBNISSN" placeholder="978-3-16-148410-0" required style="padding-right:40px;" value="{{ $kitap->kunyeISBNISSN }}" />
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="text" class="form-input" id="kunyeDemirbasKN" name="kunyeDemirbasKN"
                                               ...
                                               title="Demirbaş numarası otomatik oluşturulur" />
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeCilt">Cilt</label>
                                        <input type="text" class="form-input" id="kunyeCilt" name="kunyeCilt" placeholder="Örnek: 1. Cilt" value="{{ $kitap->kunyeCilt }}" />
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeKopya">Kopya Sayısı</label>
                                        <input type="number" class="form-input" id="kunyeKopya" name="kunyeKopya" value="{{ $kitap->kunyeKopya ?? 1 }}" min="1" />
                                    </div>
                                </div>
                                ...
                                <div class="form-grid cols-2" style="margin-top:16px;">
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="turCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="turIdSearch" placeholder="Tür ara veya seçin…" autocomplete="off" value="{{ $turler->firstWhere('id', $kitap->turId)?->ad ?? '' }}" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                        ...
                                        <input type="hidden" id="turId" name="turId" value="{{ $kitap->turId }}" />
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="altTurCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="altTurIdSearch" placeholder="Alt tür ara veya seçin…" autocomplete="off" value="{{ $altturler->firstWhere('id', $kitap->altTurId)?->ad ?? '' }}" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                        ...
                                        <input type="hidden" id="altTurId" name="altTurId" value="{{ $kitap->altTurId }}" />
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="sekilCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="sekilIdSearch" placeholder="Şekil ara veya seçin…" autocomplete="off" value="{{ $sekiller->firstWhere('id', $kitap->sekilId)?->ad ?? '' }}" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                        ...
                                        <input type="hidden" id="sekilId" name="sekilId" value="{{ $kitap->sekilId }}" />
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="ortamCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="ortamIdSearch" placeholder="Ortam ara veya seçin…" autocomplete="off" value="{{ $ortamlar->firstWhere('id', $kitap->ortamId)?->ad ?? '' }}" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                        ...
                                        <input type="hidden" id="ortamId" name="ortamId" value="{{ $kitap->ortamId }}" />
                                ...
                                <div style="margin-top:16px;">
                                    ...
                                    <input type="hidden" id="ustEserKatalogId" name="ustEserKatalogId" value="{{ $kitap->ustEserKatalogId }}" />
                                </div>
                            </div>
                                ...
                                <div class="form-grid cols-3">
                                    <div class="form-field">
                                        ...
                                        <div class="combobox-wrapper" id="publisherCombobox">
                                            <div class="combobox-input-wrap">
                                                <input type="text" class="form-input" id="kunyeYayinlayanSearch" placeholder="Yayınevi yazın veya seçin" autocomplete="off" value="{{ $kitap->kunyeYayinlayan }}" />
                                                <button type="button" class="combobox-toggle" tabindex="-1" aria-label="Seçenekleri aç">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
                                                </button>
                                            </div>
                                        ...
                                        <input type="hidden" id="kunyeYayinlayan" name="kunyeYayinlayan" value="{{ $kitap->kunyeYayinlayan }}" />
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="text" class="form-input" id="kunyeYayinTarihi" name="kunyeYayinTarihi" placeholder="Örnek: 2024 veya Mart 2024" value="{{ $kitap->kunyeYayinTarihi }}" />
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeBasimKaydi">Basım Kaydı</label>
                                        <input type="text" class="form-input" id="kunyeBasimKaydi" name="kunyeBasimKaydi" placeholder="Örnek: 3. baskı" value="{{ $kitap->kunyeBasimKaydi }}" />
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeYayinYeri">Yayın Yeri</label>
                                        <input type="text" class="form-input" id="kunyeYayinYeri" name="kunyeYayinYeri" placeholder="Örnek: İstanbul" value="{{ $kitap->kunyeYayinYeri }}" />
                                    </div>
                                    <div class="form-field">
                                        ...
                                        <input type="text" class="form-input" id="kunyeSorumlular" name="kunyeSorumlular" placeholder="Örnek: Çev. Ahmet Yılmaz ; Ed. Mehmet Demir" value="{{ $kitap->kunyeSorumlular }}" />
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeDiziKaydi">Dizi Kaydı</label>
                                        <input type="text" class="form-input" id="kunyeDiziKaydi" name="kunyeDiziKaydi" placeholder="Örnek: Dünya Klasikleri ; 12" value="{{ $kitap->kunyeDiziKaydi }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="form-grid cols-3">
                                    <div class="form-field">
                                        ...
                                        <input type="hidden" id="kunyeKategori" name="kunyeKategori" value="{{ $kitap->kunyeKategori }}" />
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="text" class="form-input" id="kunyeSiniflamaYer" name="kunyeSiniflamaYer" placeholder="Örnek: 603.41/FER" value="{{ $kitap->kunyeSiniflamaYer }}" />
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeKonuBasligi">Konu Başlığı</label>
                                        <textarea class="form-textarea" id="kunyeKonuBasligi" name="kunyeKonuBasligi" placeholder="Örnek: Roman -- Fransız edebiyatı" rows="3">{{ $kitap->kunyeKonuBasligi }}</textarea>
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeDilKN">Dil</label>
                                        <select class="form-select" id="kunyeDilKN" name="kunyeDilKN">
                                            <option value="" disabled {{ $kitap->kunyeDilKN ? '' : 'selected' }}>Dil seçin</option>
                                            @foreach(['Türkçe','İngilizce','Almanca','Fransızca','Arapça','İspanyolca','Rusça','Farsça','Diğer'] as $dil)
                                                <option value="{{ $dil }}" {{ $kitap->kunyeDilKN === $dil ? 'selected' : '' }}>{{ $dil }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-field">
                                        <label class="form-label" for="kunyeFizikselTanim">Fiziksel Tanım</label>
                                        <input type="text" class="form-input" id="kunyeFizikselTanim" name="kunyeFizikselTanim" placeholder="Örnek: 350 s. ; 21 cm." value="{{ $kitap->kunyeFizikselTanim }}" />
                                    </div>
                                    <div class="form-field">
                                    ...
                                    <div class="form-field span-2">
                                        ...
                                        <textarea class="form-textarea" id="icerik" name="icerik" placeholder="Kitabın içindekiler bilgisi…" rows="3">{{ $kitap->icerik }}</textarea>
                                    </div>
                                    <div class="form-field span-2">
                                        <label class="form-label" for="aciklama">Açıklama</label>
                                        <textarea class="form-textarea" id="aciklama" name="aciklama" placeholder="Kitap hakkında açıklama…" rows="3">{{ $kitap->aciklama }}</textarea>
                                    </div>
                                    <div class="form-field span-2">
                                        <label class="form-label" for="ozelNotlar">Özel Notlar</label>
                                        <textarea class="form-textarea" id="ozelNotlar" name="ozelNotlar" placeholder="Kütüphaneye özel notlar…" rows="3">{{ $kitap->ozelNotlar }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div style="margin-top:24px;">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <select class="form-select" id="girisTuruId" name="girisTuruId">
                                                ...
                                                @foreach($girisTurleri as $gt)
                                                    <option value="{{ $gt->id }}" data-ad="{{ $gt->ad }}" {{ $kitap->girisTuruId == $gt->id ? 'selected' : '' }}>
                                                        {{ $gt->ad }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div id="satin-alma-fields" class="form-grid cols-3" style="display:none;margin-top:16px;">
                                        <div class="form-field">
                                            ...
                                            <input type="text" class="form-input" id="faturaNo" name="faturaNo" placeholder="Örnek: FTR-2024-001" value="{{ $kitap->faturaNo }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="faturaTarihi">Fatura Tarihi</label>
                                            <input type="date" class="form-input" id="faturaTarihi" name="faturaTarihi" value="{{ $kitap->faturaTarihi }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="tedarikci">Firma Adı</label>
                                            <input type="text" class="form-input" id="tedarikci" name="tedarikci" placeholder="Örnek: Kitapsan A.Ş." value="{{ $kitap->tedarikci }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="tedarikciTelefon">Telefon</label>
                                            <input type="text" class="form-input" id="tedarikciTelefon" name="tedarikciTelefon" placeholder="Örnek: 0212 555 00 00" value="{{ $kitap->tedarikciTelefon }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="tedarikciEposta">E-posta Adresi</label>
                                            <input type="email" class="form-input" id="tedarikciEposta" name="tedarikciEposta" placeholder="ornek@firma.com" value="{{ $kitap->tedarikciEposta }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="fiyat">Fiyat (₺)</label>
                                            <input type="number" class="form-input" id="fiyat" name="fiyat" placeholder="0.00" step="0.01" min="0" value="{{ $kitap->fiyat }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div id="hibe-fields" class="form-grid cols-3" style="display:none;margin-top:16px;">
                                        <div class="form-field">
                                            ...
                                            <input type="text" class="form-input" id="tedarikci_hibe" placeholder="Kurum veya kişi adı" value="{{ $kitap->tedarikci }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="tedarikciTelefon_hibe">Telefon</label>
                                            <input type="text" class="form-input" id="tedarikciTelefon_hibe" placeholder="Örnek: 0212 555 00 00" value="{{ $kitap->tedarikciTelefon }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="tedarikciEposta_hibe">E-posta Adresi</label>
                                            <input type="email" class="form-input" id="tedarikciEposta_hibe" placeholder="ornek@kurum.com" value="{{ $kitap->tedarikciEposta }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div id="bagis-fields" class="form-grid cols-3" style="display:none;margin-top:16px;">
                                        <div class="form-field">
                                            ...
                                            <input type="text" class="form-input" id="tedarikci_bagis" placeholder="Bağışlayan kişi veya kurum" value="{{ $kitap->tedarikci }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="tedarikciTelefon_bagis">Telefon</label>
                                            <input type="text" class="form-input" id="tedarikciTelefon_bagis" placeholder="Örnek: 0212 555 00 00" value="{{ $kitap->tedarikciTelefon }}" />
                                        </div>
                                        <div class="form-field">
                                            <label class="form-label" for="tedarikciEposta_bagis">E-posta Adresi</label>
                                            <input type="email" class="form-input" id="tedarikciEposta_bagis" placeholder="ornek@eposta.com" value="{{ $kitap->tedarikciEposta }}" />
                                        </div>
                                    </div>

                                    {{-- Gizli gerçek input'lar - JS ile doldurulur --}}
                                    <input type="hidden" id="tedarikci_hidden" name="tedarikci" value="{{ $kitap->tedarikci }}" />
                                    <input type="hidden" id="tedarikciTelefon_hidden" name="tedarikciTelefon" value="{{ $kitap->tedarikciTelefon }}" />
                                    <input type="hidden" id="tedarikciEposta_hidden" name="tedarikciEposta" value="{{ $kitap->tedarikciEposta }}" />
                                </div>
                            </div>
                                ...
                                <div class="form-grid cols-3">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <select class="form-select" id="kunyeDurum" name="kunyeDurum">
                                            @php $durumlar = ['Rafta' => 'Rafta (Müsait)', 'Ödünç' => 'Ödünç Verildi', 'Kayıp' => 'Kayıp', 'Bakımda' => 'Bakımda / Onarımda', 'Hurdaya Ayrıldı' => 'Hurdaya Ayrıldı']; @endphp
                                            @foreach($durumlar as $val => $label)
                                                <option value="{{ $val }}" {{ $kitap->kunyeDurum === $val ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <select class="form-select form-select-required" id="kutuphaneId" name="kutuphaneId" required>
                                            ...
                                            @foreach($kutuphaneler as $kutuphane)
                                                <option value="{{ $kutuphane->id }}"
                                                    {{ $kitap->kutuphaneId == $kutuphane->id ? 'selected' : '' }}>
                                                    {{ $kutuphane->title }}
                                                </option>
                                            @endforeach
                                        </select>
...
<script>
    ...
    bookForm.addEventListener('submit', function(e) {
        ...
        // kunyeYazar hidden alanını doldur (controller find-or-create için)
        document.getElementById('kunyeYazar').value = author;
        // kunyeYayinlayan hidden alanını doldur
    ...
    function resetForm() {
        ...
        document.getElementById('kunyeYayinlayan').value = '';
        document.getElementById('kunyeYazarSearch').value = '';
        document.getElementById('kunyeYayinlayanSearch').value = '';
        document.getElementById('kunyeSiniflamaYer').value = '';

        // Tür / Alt Tür / Şekil / Ortam sıfırla
        ['turId','altTurId','sekilId','ortamId'].forEach(function(id) {
            var el = document.getElementById(id);
            if (el) el.value = '';
        });
        // Arama inputlarını da temizle
        ['turIdSearch','altTurIdSearch','sekilIdSearch','ortamIdSearch'].forEach(function(id) {
            var el = document.getElementById(id);
            if (el) el.value = '';
        });
        ...
        var kategoriSelect = document.getElementById('kunyeKategori');
        if (kategoriSelect) kategoriSelect.selectedIndex = 0;

        // Reset kategori combobox
        if (window.resetKategoriCombobox) window.resetKategoriCombobox();

        // Close all combobox dropdowns
    ...
    // Kategori combobox ile aynı pattern: arama text → hidden id/text
    // ============================
    (function() {
        function initDbCombobox(cfg) {
            // cfg: { wrapperId, searchInputId, hiddenInputId, dataScriptId, labelKey, strict }
            ...
            function render(filter) {
                ...
                if (filtered.length === 0) {
                    ...
                    // strict modda "yeni eklenecek" ipucu gösterilmez
                    if (term && !strict) html += '<div class="combobox-hint">Enter ile "' + esc(searchInput.value.trim()) + '" yeni olarak eklenecek</div>';
                } else {
                    filtered.forEach(function(r, i) {
                        var sel  = (searchInput.value.toLowerCase() === r[cfg.labelKey].toLowerCase());
                        var high = (i === highlightedIndex);
                        html += '<div class="combobox-option' + (sel?' selected':'') + (high?' highlighted':'') + '" data-val="' + esc(r[cfg.labelKey]) + '">';
                ...
                dropdown.querySelectorAll('.combobox-option').forEach(function(el) {
                    el.addEventListener('mousedown', function(e) {
                        e.preventDefault();
                        selectOption(this.getAttribute('data-val'));
                    });
                });
            }
            ...
            function open()  { highlightedIndex = -1; render(searchInput.value); dropdown.classList.add('visible'); toggle.classList.add('open'); }
            function close() { dropdown.classList.remove('visible'); toggle.classList.remove('open'); highlightedIndex = -1; }
            function isOpen() { return dropdown.classList.contains('visible'); }

            toggle.addEventListener('mousedown', function(e) { e.preventDefault(); isOpen() ? close() : (open(), searchInput.focus()); });
            searchInput.addEventListener('focus',  function() { open(); });
            searchInput.addEventListener('input',  function() {
                if (!strict) hiddenInput.value = this.value.trim(); // serbest giriş sadece strict olmayan modda
                highlightedIndex = -1;
                render(this.value);
                if (!isOpen()) open();
            });
            ...
            searchInput.addEventListener('keydown', function(e) {
                ...
                if (e.key === 'ArrowDown') { e.preventDefault(); highlightedIndex = Math.min(highlightedIndex + 1, filtered.length - 1); render(searchInput.value); var h = dropdown.querySelector('.highlighted'); if (h) h.scrollIntoView({block:'nearest'}); }
                    ...
                    if (highlightedIndex >= 0 && filtered[highlightedIndex]) {
                        selectOption(filtered[highlightedIndex][cfg.labelKey]);
                    } else if (!strict && searchInput.value.trim()) {
                        // strict değilse serbest metin kabul et
                        hiddenInput.value = searchInput.value.trim();
                        close();
                    } else if (strict) {
                        // strict modda eşleşme yoksa temizle
                        searchInput.value = '';
                        hiddenInput.value = '';
                        close();
                    }
        ...
        initDbCombobox({ wrapperId: 'turCombobox',    searchInputId: 'turIdSearch',    hiddenInputId: 'turId',    dataScriptId: 'turData',    labelKey: 'ad', strict: true });
        initDbCombobox({ wrapperId: 'altTurCombobox', searchInputId: 'altTurIdSearch', hiddenInputId: 'altTurId', dataScriptId: 'altTurData', labelKey: 'ad', strict: true });
        initDbCombobox({ wrapperId: 'sekilCombobox',  searchInputId: 'sekilIdSearch',  hiddenInputId: 'sekilId',  dataScriptId: 'sekilData',  labelKey: 'ad', strict: true });
        initDbCombobox({ wrapperId: 'ortamCombobox',  searchInputId: 'ortamIdSearch',  hiddenInputId: 'ortamId',  dataScriptId: 'ortamData',  labelKey: 'ad', strict: true });
    })();
    ...
    (function () {
        ...
        toggle.addEventListener('mousedown', function(e) {
            e.preventDefault();
            isOpen() ? close() : (open(), searchInput.focus());
        });
        ...
        // Reset butonuyla sıfırlanabilmesi için global erişim
        window.resetKategoriCombobox = function() {
            selectedId    = '';
            selectedTitle = '';
            hiddenInput.value  = '';
            searchInput.value  = '';
    ...
    (function () {
        ...
        // Kaynak input'lar (görünen - her panel için)
        function getVisible() {
            var ad  = girisTuruSel.options[girisTuruSel.selectedIndex]
                ? (girisTuruSel.options[girisTuruSel.selectedIndex].dataset.ad || '') : '';
        ...
        // Sayfa yüklenince old() değerine göre uygula
        applyGirisTuru();
    })();
