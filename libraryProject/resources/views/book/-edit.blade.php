                        ...
                        <div class="fields-section">
                            ...
                            <div>
                                ...
                                <div class="form-grid cols-3">
                                    ...
                                    <div class="form-field">
                                        <label class="form-label" for="created_user">Kaydeden</label>
                                        <input type="number" class="form-input" id="created_user" name="created_user" placeholder="Kaydeden" value="{{ old('created_user', $kitap->created_user) }}" />
                                    </div>
                                    <div class="form-field">
            ...
            function render(filter) {
                ...
                if (filtered.length === 0) {
                    ...
                    filtered.forEach(function(r, i) {
                        ...
                        html += '<div class="combobox-option' + (sel?' selected':'') + (i===highlightedIndex?' highlighted':'') + '" data-val="' + esc(r[cfg.labelKey]) + '">';
                ...
                dropdown.querySelectorAll('.combobox-option').forEach(function(el) {
                    el.addEventListener('mousedown', function(e) { e.preventDefault(); selectOption(this.getAttribute('data-val')); });
                });
            }
            function selectOption(val) { searchInput.value = val; hiddenInput.value = val; close(); searchInput.focus(); }
