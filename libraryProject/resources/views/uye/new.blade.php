...
<head>
    ...
    <title>Yeni Üye — Beyoğlu Kütüphane Sistemi</title>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* Adres Sonuç Paneli */
        .adres-sonuc-panel{border-radius:calc(var(--radius) - 2px);overflow:hidden;margin-bottom:4px}
        ...
        /* spin animasyonu için kullanılır */
    ...
    <main class="main-content" id="mainContent">
        <div class="top-header">
            ...
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-current">Yeni Üye</span>
            </nav>
        </div>

        <div class="content-area">
            <form method="POST" action="{{ route('uyeler.store') }}" id="uyeForm">
                @csrf
                <div class="form-card">
                    <div class="form-card-header">
                        ...
                        <p class="form-card-desc">Kütüphane üyesi eklemek için formu doldurun. Telefon numarası SMS ile doğrulanmalıdır.</p>
                    </div>
                    ...
                    <div class="form-card-body">
                            ...
                            <div class="form-grid cols-2">
                                ...
                                <div class="form-field">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <input type="email" id="email" name="email"
                                               ...
                                               value="{{ old('email') }}" placeholder="ornek@eposta.com" autocomplete="email" />
                                    </div>
                                    @error('email')
                                    <div class="form-error"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-field">
                                    <label class="form-label" for="telefon">
                                        ...
                                        <span class="hint">(SMS doğrulama gereklidir)</span>
                                    </label>
                                    <div class="input-wrap" style="display:flex;gap:8px;">
                                        ...
                                        <button type="button" id="btnSendOtp" class="btn btn-ghost btn-sm" style="white-space:nowrap;" onclick="sendOtp()">
                                ...
                                <div class="span-2" id="otpSection" style="display:none;">
                                    <div class="otp-box">
                                        <div class="otp-status pending" id="otpStatus">
                                            ...
                                            <span id="otpStatusText">Doğrulama kodu gönderildi. Lütfen girin.</span>
                                        </div>
                                        <div class="otp-row" id="otpInputRow">
                                        ...
                                        <div id="otpVerifiedRow" style="display:none;">
                                            ...
                                            <button type="button" class="btn btn-outline btn-sm" style="margin-left:10px;" onclick="resetOtp()">Değiştir</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-field">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <input type="tel" id="telefon2" name="telefon2"
                                               ...
                                               value="{{ old('telefon2') }}" placeholder="05xxxxxxxxx" maxlength="11" inputmode="tel" />
                                    </div>
                                    @error('telefon2')
                                    <div class="form-error"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-grid cols-3">
                                <div class="form-field">
                                    ...
                                    <input type="text" id="il" name="il"
                                           class="form-input {{ $errors->has('il') ? 'is-error' : '' }}"
                                           value="{{ old('il') }}" placeholder="İl adı (adres sorgulamayla KPS'den gelir)" autocomplete="address-level1" />
                                </div>
                                <div class="form-field">
                                    <label class="form-label" for="ilce">İlçe</label>
                                    <input type="text" id="ilce" name="ilce"
                                           class="form-input {{ $errors->has('ilce') ? 'is-error' : '' }}"
                                ...
                                <div class="form-field">
                                    ...
                                    <input type="text" id="mahalle" name="mahalle"
                                           class="form-input {{ $errors->has('mahalle') ? 'is-error' : '' }}"
                            ...
                            <div class="form-grid cols-2">
                                <div class="form-field span-2">
                                    ...
                                    <select id="ogretim_durumu" name="ogretim_durumu"
                                        ...
                                        @foreach(['İlkokul','Ortaokul','Lise','Önlisans','Lisans','Yüksek Lisans','Doktora'] as $seviye)
                                            <option value="{{ $seviye }}" {{ old('ogretim_durumu') === $seviye ? 'selected' : '' }}>{{ $seviye }}</option>
                                        @endforeach
                                    </select>
                                    @error('ogretim_durumu')
                                    <div class="form-error"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-field">
                                    ...
                                    <input type="text" id="okul_adi" name="okul_adi"
                                           ...
                                           value="{{ old('okul_adi') }}" placeholder="Okul adını girin" />
                                    @error('okul_adi')
                                    <div class="form-error"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-field">
                                    ...
                                    <input type="text" id="bolum_adi" name="bolum_adi"
                                           ...
                                           value="{{ old('bolum_adi') }}" placeholder="Bölüm adını girin" />
                                    @error('bolum_adi')
                                    <div class="form-error"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-grid cols-2">
                                <div class="form-field">
                                    ...
                                    <input type="date" id="uyelik_baslangic" name="uyelik_baslangic"
                                           class="form-input"
                                           value="{{ old('uyelik_baslangic', date('Y-m-d')) }}" />
                                </div>
                                <div class="form-field">
                                ...
                                <div class="form-field span-2">
                                    ...
                                    <div class="statu-cards">
                                        <label class="statu-card">
                                            <input type="radio" name="statu" value="aktif" {{ old('statu', 'aktif') === 'aktif' ? 'checked' : '' }} />
                                            ...
                                            <div class="statu-check"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>
                                        </label>
                                        <label class="statu-card">
                                            <input type="radio" name="statu" value="pasif" {{ old('statu') === 'pasif' ? 'checked' : '' }} />
                                            <div class="statu-card-inner">
                                ...
                                <div class="form-field span-2">
                                    ...
                                    <textarea id="notlar" name="notlar" class="form-textarea"
                                              placeholder="Üye hakkında özel notlar…">{{ old('notlar') }}</textarea>
                                </div>
                            </div>
                        </div>

                        {{-- ── 5. Veli Bilgileri (18 yaş altı için otomatik açılır) ── --}}
                        <div id="veliSection" style="display:none;">
                            <div class="section-sep"></div>
                            <div style="margin-top:24px;">
                                ...
                                <div class="form-grid cols-2">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="text" id="veli_soyad" name="veli_soyad"
                                               class="form-input {{ $errors->has('veli_soyad') ? 'is-error' : '' }}"
                                               value="{{ old('veli_soyad') }}" placeholder="Velinin soyadı" autocomplete="off" />
                                        @error('veli_soyad')
                                        <div class="form-error"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="input-wrap">
                                            <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.18 2 2 0 0 1 3.6 1h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.68 2.81a2 2 0 0 1-.45 2.11L7.91 8.56a16 16 0 0 0 8 8l.92-.92a2 2 0 0 1 2.11-.45c.91.32 1.85.55 2.81.68A2 2 0 0 1 22 16.92z"/></svg>
                                            <input type="tel" id="veli_telefon" name="veli_telefon"
                                                   class="form-input has-icon {{ $errors->has('veli_telefon') ? 'is-error' : '' }}"
                                                   value="{{ old('veli_telefon') }}" placeholder="05xxxxxxxxx"
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" id="btnSubmit" class="btn btn-primary" onclick="submitForm()" disabled>
...
<script>
    ...
    function sendOtp() {
        ...
        if (!telefon) { showToast('error', 'Telefon giriniz', 'Lütfen önce telefon numarasını girin.'); return; }
        ...
        fetch('{{ route('otp.gonder') }}', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    showToast('error', 'SMS gönderilemedi', data.message);
                    btn.disabled = false;
    ...
    function verifyOtp() {
        ...
        if (!kod || kod.length !== 6) { showToast('error', 'Kod giriniz', '6 haneli doğrulama kodunu girin.'); return; }
    ...
    function startCountdown(seconds) {
        ...
        function tick() {
            ...
            if (remaining === 0) {
                ...
                if (!otpVerified) {
                    document.getElementById('otpStatusText').textContent = 'Kodun süresi doldu. Yeniden gönderin.';
                }
            }
            remaining--;
        }
    ...
    function submitForm() {
        if (!otpVerified) {
            showToast('error', 'Telefon doğrulanmamış', 'Lütfen önce telefon numarasını doğrulayın.');
            return;
        }

        // Veli bölümü açıksa zorunlu alanları kontrol et
        var veliSection = document.getElementById('veliSection');
        if (veliSection.style.display !== 'none') {
            var veliFields = ['veli_ad', 'veli_soyad', 'veli_tc_kimlik', 'veli_dogum_tarihi', 'veli_telefon'];
            for (var i = 0; i < veliFields.length; i++) {
                var el = document.getElementById(veliFields[i]);
                if (!el.value.trim()) {
                    showToast('error', 'Veli bilgileri eksik', 'Lütfen tüm veli bilgilerini doldurun.');
                    el.focus();
                    return;
                }
            }
        ...
        const form = document.getElementById('uyeForm');
        const btn = document.getElementById('btnSubmit');
        const originalBtnHtml = btn.innerHTML;

        btn.disabled = true;
        btn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="animation:spin .6s linear infinite; margin-right:8px;"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg> Kaydediliyor...';
        ...
        fetch(form.action, {
            ...
            .catch(error => {
                ...
                showToast('error', 'Sistem Hatası', 'Sunucuya bağlanılamadı.');
                btn.disabled = false;
                btn.innerHTML = originalBtnHtml;
            });
    }

    // ── Yaş Kontrolü — Veli Bölümünü Göster/Gizle ────────────────────────────
    function checkAge() {
        var dogumTarihi = document.getElementById('dogum_tarihi').value;
        if (!dogumTarihi) {
            setVeliRequired(false);
            return;
        }
        ...
        var ayFark = bugun.getMonth() - dogum.getMonth();
        if (ayFark < 0 || (ayFark === 0 && bugun.getDate() < dogum.getDate())) {
            yas--;
        }

        setVeliRequired(yas < 18);
    }

    function setVeliRequired(isMinor) {
        var section = document.getElementById('veliSection');
        var veliInputs = section.querySelectorAll('input[id^="veli_"]');

        if (isMinor) {
            section.style.display = 'block';
            veliInputs.forEach(function(el) { el.setAttribute('required', 'required'); });
        } else {
            section.style.display = 'none';
            veliInputs.forEach(function(el) { el.removeAttribute('required'); });
        }
    }

    // Sayfa yüklendiğinde — eski değer varsa (validasyon hatası sonrası) yaşı kontrol et
    document.addEventListener('DOMContentLoaded', function() {
        checkAge();
        // Veli bölümü açıksa eski değerler zaten Blade tarafından doldurulmuş olacak
    });
    ...
    /** Örnek: Kaptan mahallesi, Yıldız sokak, No 15, Daire 3 Beyoğlu, İstanbul */
    ...
    /** KPS adres yanıtını forma yazar (ilAdi dahil). */
